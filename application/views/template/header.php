...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/multi-select/styles.css" />
  <!--[if lt IE 9]>
        ...
        <div id="be-navbar-collapse" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <?php if (in_array($this->session->userdata('Role'), array(2, 4))) {  ?>
              <li <?php if ($Title == 'Add New Booking') {echo 'class="c_active"';} ?>>
                <?php if ($this->session->userdata('SupplierGroupID') == 1){ ?>
                  <a href="<?php echo base_url('Multiple_Vendor/addBookingMultipleVendor'); ?>"><i class="icon mdi mdi-car"></i> <span>Dock Booking</span></a> 
                <?php } 
                if ($this->session->userdata('SupplierGroupID') > 1){ ?>
                  <a href="<?php echo base_url('Booking/addMultiple'); ?>"><i class="icon mdi mdi-car"></i> <span>Dock Booking</span></a>
                <?php } ?>
              </li>
            <?php } ?>
            <?php if (in_array($this->session->userdata('Role'), array(1, 3))) {  ?>
              <li <?php if ($Title == 'Add New Booking') {echo 'class="c_active"';} ?>>
                <a href="<?php echo base_url('Booking/Add'); ?>"><i class="icon mdi mdi-car"></i> <span>Dock Booking</span></a>
              </li>
            <?php } ?>
            ...
            if ($this->session->userdata('Role') == 7) { ?>
              <li><a href="<?php echo base_url('Booking/securityC2'); ?>"><i class="icon mdi mdi-shield-security"></i> Security Check C2</a></li>
            <?php }
            ...
            if ($this->session->userdata('Role') == 8) { ?>
              <li><a href="<?php echo base_url('Booking/warehouseCheckC2'); ?>"><i class="icon mdi mdi-shield-security"></i> Warehouse Check C2</a></li>
              <!-- <li><a href="<?php //echo base_url('Booking/QcCheck');?>"><i class="icon mdi mdi-shield-check"></i> QC Checking</a></li> -->
            <?php }
            ...
            <?php }
            if (in_array($this->session->userdata('Role'), array(5, 6, 7, 8))) { ?>
              <li class="dropdown"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="dropdown-toggle"><i class="icon mdi mdi-local-shipping"></i> Shipment Details <span class="mdi mdi-caret-down"></span></a>
                <ul role="menu" class="dropdown-menu">
                  <li><a href="<?php echo base_url('Booking/Today'); ?>">Today's Shipment</a></li>
                  <li <?php if ($Page == 'Upcoming') {
                        echo 'class="c_active"';
                      } ?>><a href="<?php echo base_url('Booking/Upcoming'); ?>">Upcoming Shipment</a></li>
                </ul>
              </li>
            <?php }
            if (!in_array($this->session->userdata('Role'), array(5, 6, 7, 8))) { ?>
              <li class="dropdown"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="dropdown-toggle"><i class="icon mdi mdi-account"></i> Admin <span class="mdi mdi-caret-down"></span></a>
                <ul role="menu" class="dropdown-menu">
                  <?php if (in_array($this->session->userdata('Role'), array(1, 3))) { ?>
                    ...
                    <li><a href="<?php echo base_url('Users/QC'); ?>">Update Warehouse Details</a></li>
            ...
            if (in_array($this->session->userdata('Role'), array(1, 3))) { ?>
              <li <?php if ($Page == 'Reports') {
                    echo 'class="c_active"';
                  } ?>><a href="<?php echo base_url('Reports'); ?>"><i class="icon mdi mdi-widgets"></i> <span>Statistics & Reports</span></a></li>
            <?php } else { ?>
              <li><a href="<?php echo base_url('Dashboard/Help'); ?>"><span class="icon mdi mdi-help-outline"></span> Help</a></li>
            <?php } ?>
          </ul>
