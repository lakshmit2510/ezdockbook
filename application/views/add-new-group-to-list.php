          ...
          <div class="panel-body">
            <form action="<?php echo base_url('Users/saveGroup'); ?>" class="form-horizontal" method="post">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <select multiple name="BuildingName" data-parsley-trigger="keyup" class="form-control dockselect required" required="true" id="BuildingName">
                    <!-- <option value="">--- Choose Building ---</option> -->
                    <option value="ICC1">Inflight Catering Centre 1 (ICC1)</option>
                    <option value="ICC2">Inflight Catering Centre 2 (ICC2)</option>
                  </select>
                </div>
              </div>
      ...
      <script type="text/javascript">
        $(document).ready(function() {
          ...
          $('[type="submit"]').on('click', function(evt) {
            ...
            var buildingValuesarray = $('[name="BuildingName"]').val();
            var buildingName = buildingValuesarray.toString();
