        ...
        <div class="col-sm-9">
          ...
          <div class="panel panel-default panel-border-color panel-border-color-primary be-loading">
            ...
            <div class="panel-body">
              ...
              <div class="form-group">
                <label class="col-sm-3 control-label"><b>Email Address 1</b></label>
                <?php echo $Profile->EmailAddress1; ?>
              </div>
              <a href="#"></a>
              <div class="form-group">
                <label class="col-sm-3 control-label"><b>Email Address 2</b></label>
                <?php echo $Profile->EmailAddress2; ?>
              </div>
              <div class="form-group">
