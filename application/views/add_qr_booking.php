    ...
    <div class="main-content container-fluid">
            ...
            <div class="col-md-12 fuelux">
                ...
                <div class="block-wizard panel panel-default panel-border-color panel-border-color-primary be-loading">
                    <div id="wizard1" class="wizard wizard-ux no-steps-container">
                        ...
                        <form action="<?php echo base_url('Multiple_Vendor/saveBooking'); ?>" class="form-horizontal" method="post" enctype="multipart/form-data">
                            <div class="step-content">
                                ...
                                <div data-step="1" class="step-pane active">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group docktypestyle" id="AvailableDocks"></div>
                                    </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $('#SlotType,#BuildingName').change(function() {
                    CheckIn = $('#CheckIn').val();
                    datas = new FormData();
